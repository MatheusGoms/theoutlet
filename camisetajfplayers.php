...
<html lang="pt-br">
  ...
  <body>
    ...
    <script src="https://stackpath.bootstrapcdn.com/bootstrap/4.2.1/js/bootstrap.min.js" integrity="sha384-B0UglyR+jN6CkvvICOB2joaf5I4l3gm9GU6Hc1og6Ls7i6U/mkkaduKaBhlAXv9k" crossorigin="anonymous"></script>
		...
		<section>
			<div class="camisastst">
				<br>
				<h1 class="fonte"></h1>		
				<figure class="camisa1">
					<img src="pcimg/camisetajustforplayers/camisa1.jpg"></a>
						
				</figure>
				<figure class="camisa4">
					<img src="pcimg/camisetajustforplayers/teste.jpg"></a><a href="gerarboleto.php"><img src="pcimg/camisetajustforplayers/comprar.jpg"></a>

				</figure>
				<br>
				<br>
				<br>
				<h8 class="asd"><i>Tabela de Medidas</i></h8>
				<figure class="tabmedidas">
					<img src="pcimg/camisetajustforplayers/tabmedidas.jpg"></a>
